...
const Skills = () => {
  return (
      <div name="skills" className="flex flex-col m-auto justify-normal w-full">
          <h2 className="text-3xl text-left font-semibold text-[#646cff] mb-7 mr-32 underline underline-offset-8">
              Skills
          </h2>
          <div className="w-full flex flex-col justify-center sm:flex-row sm:justify-between mb-48">
